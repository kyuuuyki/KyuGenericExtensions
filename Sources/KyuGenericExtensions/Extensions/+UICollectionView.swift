...
public extension UICollectionView {
	...
	///   The data source receives this information 
	///   when it is asked for the cell and should just pass it along.
	///   This method uses the index path to perform additional configuration 
	///   based on the cell’s position in the collection view.
	///
	/// - Returns: A valid `UICollectionViewCell` object. 
	/// `Nil` if the specify cell cannot dequeue from collection view or cast into the valid cell type.
	...
	/// `Nil` if the specify view cannot dequeue from collection view or cast into the valid view type.
